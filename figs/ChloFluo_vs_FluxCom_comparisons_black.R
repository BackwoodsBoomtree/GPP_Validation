...
print(paste0("Annual total Pg C for FluxCom is: ", gpp_annual_total))      
...
labs <- c(expression(paste("ChloFluo Mean Annual GPP 2019")),
          expression(paste("FluxCom Mean Annual GPP 2019")),
          expression(paste("GPP Difference: ChloFluo - FluxCom")),
          expression(paste("Correlation for ChloFluo vs FluxCom")))
