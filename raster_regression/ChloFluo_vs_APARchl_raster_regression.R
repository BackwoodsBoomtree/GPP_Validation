...
y_name     <- "gpp"
x_name     <- "aparchl"
out_dir    <- "G:/ChloFluo/comps/APARchl/raster_regressions"
out_name   <- "ChlFluo_vs_APARchl.v01.1deg.CF80.2019.clipfill"
...
rast_reg(cf_file, apar_file, y_name, x_name, out_dir, out_name)