...
c_file   <- "G:/CLIMA/clipfill/a8_gm2_wd1_2019_1X_8D.c3.epar.clipfill.nc"
t_file   <- "G:/ChloFluo/input/SIF/1deg/clipfill/SIFqc.8day.1deg.veg_only.CF80.2019.clipfill.nc"
y_name   <- "clima_sif"
x_name   <- "sif743_qc"
out_dir  <- "G:/ChloFluo/comps/clima_sif/raster_regressions"
out_name <- "CLIMA_vs_TROPOMI_SIF.v02.1deg.CF80.2019.clipfill"
...
rast_reg(c_file, t_file, y_name, x_name, out_dir, out_name)
