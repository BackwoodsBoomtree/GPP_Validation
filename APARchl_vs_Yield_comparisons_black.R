...
r2_map           <- raster("G:/ChloFluo/comps/aparchl_vs_yield/raster_regressions/APARchl_vs_SIFyield.v01.1deg.CF80.2019.clipfill_Rsquare.tif")
pval_map         <- raster("G:/ChloFluo/comps/aparchl_vs_yield/raster_regressions/APARchl_vs_SIFyield.v01.1deg.CF80.2019.clipfill_Pval.tif")
